...
echo "--- Starting EAS local build (profile: ${PROFILE}) ---"
for attempt in 1 2 3; do
	if eas build --local --platform android --profile "${PROFILE}" --non-interactive; then
		echo "--- Build complete. APK/AAB is in your project folder. ---"
		exit 0
	fi
